...
- 2026-09-23 workshop-captures (`06`): 3 scenarios, 3 passed. 696 active. Three meal-card images, reviewed and approved by the owner on 2026-09-24, cropped to 1000x810 and copied into `Art/Workshop-captures/` (the raw run keeps them on disk, ignored by git). `Tests/Pickle/results/2026-09-23-workshop-captures/`.
