...
workshop:     3806100152
remaining:
  - "correction (2026-09-26): hekmo pointed out that meals of more than three ingredients are split into chunks of three and that most meals in her screenshot use three-ingredient dishes. The slot-count rule explains the meals of one or two ingredients only. For three or more, the cause is that our three-slot dishes are specific combinations: on the offline model about 2 percent of random triples can be named by one of ours (Flavor Text's generic dishes cover nearly every triple), and the game measure below agrees. A second reply to hekmo is drafted in PUBLICATION.md."
  - "measured (2026-09-26, request 78fc on the published 1.1.0 defs): share of named meals carrying a dish of this mod, 400 seeded cooks, vanilla ingredients: 2 ingredients 0.0 %, 3 ingredients 0.8 %, 4 ingredients 2.3 % (docs/runs/2026-09-26-frequency.md, Tests/Pickle/results/2026-09-26-frequency-b/). The two floors at 1 percent went red, which is the finding."
  - "unverified (2026-09-26): the 1.2.0 content (233 shorter forms, version 1.2.0 in About.xml, at b14150e) waits on three Pickle requests: bare pass 01/03/04/08 (20260926-175923-521-9c16), with optionals 02 (20260926-175926-735-486d), without Odyssey 05 (20260926-175931-968-944d). Not published. The French companion has been told about its 233 new entries; the draft 1.2.0 Steam note is in PUBLICATION.md."
  - "note (2026-09-26): the reply to hekmo explaining the slot-count rule was posted by the owner. The fix (233 shorter forms in FlavorDefs_Variants.xml: 176 two-ingredient, 57 one-ingredient of which 54 chosen by hand in _tools/solo-forms.json; Altang and Jjapaghuri to three slots) is merged into main and NOT yet played in game: unverified until 08-frequency and the new scenario `a two-ingredient dish fires` of 03-cooking run on it. Not published: no version bump yet. The French companion needs 179 entries and two texts (_tools/variants-map.json on that branch)."
  - "finding (2026-09-26, from Flavor Text's own code, FlavorText.dll 1.6 decompiled locally, not distributed): CompFlavor.GetMatchIndices only matches a dish to a chunk of ingredients with EXACTLY as many items as the dish has slots (meals are cut into chunks of 3). Flavor Text's 930 dishes have 139 one-slot, 321 two-slot and 469 three-slot definitions; this mod's 901 have 2, 1, 896 and 2 (four slots: FlavorTextExtended_Altang and FlavorTextExtended_Jjapaghuri can never match, a chunk holds at most 3). So this mod only names meals of exactly three ingredients. The draw is also weighted by Specificity = 10000 / (sum of the things each slot accepts), so a broad dish weighs less. Offline model _tools/frequency.js on the vanilla pool: about 1 to 2 percent of the draws are ours (v1.0.0: 0 to 0.7, v1.1.0: 0.6 to 2.3). A model, not a game measure: 08-frequency is."
  ...
  - "validated (earlier set): three Workshop gallery captures were generated on 2026-09-22, copied into Art/Workshop-captures/, visually approved and uploaded to the existing Steam Workshop page in their documented order."
...
The central emblem sits behind the card by design; the owner reviewed that composition and accepted it. The three files
were uploaded to the existing Workshop gallery in that order.
