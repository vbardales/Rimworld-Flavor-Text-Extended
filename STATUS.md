...
workshop:     3806100152
remaining:
  - "note (2026-09-26): the reply to hekmo explaining the slot-count rule was posted by the owner. The fix (179 shorter forms, Altang and Jjapaghuri to three slots) is on branch `arity` (4287458, pushed), not merged: merged after the frequency run 78fc has played the 1.1.0 tree. The French companion needs 179 entries and two texts (_tools/variants-map.json on that branch)."
