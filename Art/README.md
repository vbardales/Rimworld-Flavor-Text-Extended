...
`ModIcon-source.png` was edited with OpenAI's built-in image generation tool on 2026-09-13
and reduced to 128 x 128 for `Mod/About/ModIcon.png`. The final edit prompt was:
